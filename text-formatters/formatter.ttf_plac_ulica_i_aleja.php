<?php
	...
	// Template class name must be constructed as: formatter___[type]ttf_plac_ulica_i_aleja
	...
	// When saving, ___[type]ttf_plac_ulica_i_aleja will be replaced by class name entered in editor.
	Class formatterttf_plac_ulica_i_aleja extends TextFormatter {

		private $_patterns;

		public function __construct() {
			$this->_patterns = array (
				'/(\\b)(pl|Pl|al|Al|Ul|ul)\\.\\s/' => '$2.&#160;',
			);;
		}
		
		public function about() {
			return array(
				'name' => 'Plac ulica i aleja', // required
				'author' => array(
					'name' => 'Olaf Schindler',
				...
				'version' => '1.3',
				'release-date' => '2019-11-29T10:47:50+00:00',
				'description' => 'Usuwa skróty al., pl., ul. z końca wersu',
